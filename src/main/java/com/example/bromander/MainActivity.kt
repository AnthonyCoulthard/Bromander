        ...
        player1Area.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if (tempPosX1 > newPosX1 + 150){
                        lifeTotal1++
                        life1.text = lifeTotal1.toString()
                        newPosX1 = tempPosX1
                        newPosY1 = tempPosY1
                    }
                    else if (tempPosX1 < newPosX1 - 150){
                        lifeTotal1--
                        if (lifeTotal1 <= 0){
                            lifeTotal1 = 0
                        }
        ...
        player2Area.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if (tempPosX2 < newPosX2 - 150){
                        lifeTotal2++
                        life2.text = lifeTotal2.toString()
                        newPosX2 = tempPosX2
                        newPosY2 = tempPosY2
                    }
                    else if (tempPosX2 > newPosX2 + 150){
                        lifeTotal2--
                        if (lifeTotal2 <= 0){
                            lifeTotal2 = 0
                        }
        ...
        player3Area.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if (tempPosX3 < newPosX3 - 150){
                        lifeTotal3++
                        life3.text = lifeTotal3.toString()
                        newPosX3 = tempPosX3
                        newPosY3 = tempPosY3
                    }
                    else if (tempPosX3 > newPosX3 + 150){
                        lifeTotal3--
                        if (lifeTotal3 <= 0){
                            lifeTotal3 = 0
                        }
        ...
        player4Area.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    if (tempPosX4 > newPosX4 + 150){
                        lifeTotal4++
                        life4.text = lifeTotal4.toString()
                        newPosX4 = tempPosX4
                        newPosY4 = tempPosY4
                    }
                    else if (tempPosX4 < newPosX4 - 150){
                        lifeTotal4--
                        if (lifeTotal4 <= 0){
                            lifeTotal4 = 0
                        }
        ...
        player1Damage2.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    else if (tempPosY1 > newPosY1 + 150){
                        player1Damage2Int--
        ...
        player2Damage1.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    else if (tempPosY2 > newPosY2 + 150){
                        player2Damage1Int--
        ...
        player3Damage1.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    else if (tempPosY3 > newPosY3 + 150){
                        player3Damage1Int--
        ...
        player4Damage1.setOnTouchListener {v, event ->
            ...
            when (action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    else if (tempPosY4 > newPosY4 + 150){
                        player4Damage1Int--
